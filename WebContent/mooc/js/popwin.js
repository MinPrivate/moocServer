...
showWin: function(width, height, title, src) {
        ...
        var inntHtml = '';
        inntHtml += '<div id="chuankou"><div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:1999;background:#cccccc; filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity:0.5;"></div>'
        ...
        inntHtml += '</div>'
        inntHtml += '<iframe id="frame" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe></div>';
